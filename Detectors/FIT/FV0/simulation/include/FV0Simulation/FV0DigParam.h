...
struct FV0DigParam : public o2::conf::ConfigurableParamHelper<FV0DigParam> {
  ...
  float timeShiftCfd = 5.3;            // TODO: adjust after PM design for FV0 is fixed
  ...
  float timeCompensate = 8.63;         // in ns
  ...
  float timeOfFlight = 315.0/o2::constants::physics::LightSpeedCm2NS;
